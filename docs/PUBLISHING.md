# Publishing ManuscriptLint

ManuscriptLint publishes to PyPI through GitHub Actions using PyPI Trusted Publishing (OIDC). No long-lived PyPI API token is stored in GitHub.

## One-time PyPI setup

Create a pending trusted publisher for:

- PyPI project name: `manuscriptlint`
- GitHub owner: `coocoomaomao`
- Repository: `ManuscriptLint`
